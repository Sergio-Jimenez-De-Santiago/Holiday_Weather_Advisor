...
export default function CombinedGraph({ preferencesUpdated, lowThreshold, highThreshold, weatherError, weatherData1, weatherData2, displayedCity1, displayedCity2, setWeatherData1, setWeatherData2, timeRangeMode }) {
    // Debug
    useEffect(() => {
